...
model = load_model(
    'C:/Users/Administrator/Desktop/English/权重/PSE5-19/dense.h5',
...
directory = 'D:/English_paper/text222222'
...
for img_name in os.listdir(directory):
    ...
    last_conv_layer = model.get_layer("conv2d_67")
    ...
    new_img_name = img_name.split('.')[0] + 'PSE5-19' + str(class_idx) + '.jpg'
